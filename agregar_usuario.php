...
// Agregar un nuevo usuario cuando se envíe el formulario
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO usuarios (username, email, password, role_id) VALUES (:username, :email, :password, :role_id)";
...
<head>
    ...
    <title>Agregar Usuario - Spintech</title>
    ...
    <div class="layout">
        ...
        <main id="main-content" class="main-content">
            <div class="content-wrapper">
                ...
                <div class="card">
                    <p class="description">Ingrese los detalles del nuevo usuario para registrarlo en el sistema.</p>
                    <form action="agregar_usuario.php" method="POST">
                        <div class="form-group">
                            <label for="username">Nombre de Usuario:</label>
                            <input type="text" id="username" name="username" required placeholder="Ingrese el nombre de usuario">
                        </div>
                        <div class="form-group">
